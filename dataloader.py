...
class cifarn_dataset(Dataset):
    def __init__(self,  dataset,  noise_type, root_dir, transform, mode, transform_s=None, is_human=True, noise_file='',
        ...
        self.noise_path = './data/cifarn/CIFAR-10_human.pt'
...
class cifarn_dataloader():
    def __init__(self, dataset, noise_type, batch_size, num_workers, root_dir, log,
                 noise_file='',noise_mode='cifarn', r=0.2, is_human= True):
        self.r = r
        self.noise_mode = noise_mode
        self.dataset = dataset
        self.noise_type = noise_type
    ...
    def run(self, mode, pred=[], prob=[],prob2=[]):
        if mode == 'warmup':
            ...
            labeled_dataset = cifarn_dataset(dataset=self.dataset, noise_type=self.noise_type,is_human=self.is_human,
            ...
            test_dataset = cifarn_dataset(dataset=self.dataset, noise_type=self.noise_type, 
